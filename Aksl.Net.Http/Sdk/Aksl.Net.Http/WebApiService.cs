...
namespace Aksl.Net.Http
{
    public class WebApiService : IWebApiService
    {
        ...
        public string SerializeAsString<T>(T item) => JsonConvert.SerializeObject(item);

        public T DeserializeAsString<T>(string json) => JsonConvert.DeserializeObject<T>(json);
